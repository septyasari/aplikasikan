 ...
 <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Rekam Seluruh Data Inspeksi</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
              ...
              <div style="margin-bottom: 10px;">
                            <form class="form-inline" action="" method="post">
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <button type="date" class="btn btn-primary"><span class="fas fa-calendar-alt" aria-hidden="true"></span></button>
                                    </div>
