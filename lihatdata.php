        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="#" class="nav-link">
                  <i class="fas fa-thunderstorm nav-icon"></i>
                  <p>Gardu</p>
                  <i class="right fas fa-angle-left"></i>
                </a>
                <ul class="nav nav-treeview">
            ...
            <div class="card card-primary card-outline">
              <div class="card-body">
                <div class="pull-right">
                  ...
                  <a href ="tambah.php" class="btn btn-success btn-xs"><i class="fas fa-plus"></i>Tambah Data</a>
              </div>
          </h4>
                      ...
                      $hal = @$_GET['hal'];
                        if (empty ($hal)) {
                          ...
                          if ($_SERVER['REQUEST_METHOD'] == "POST"){
                            ...
                            if($pencarian != ''){
                              $sql = "SELECT*FROM tb_pelaksana WHERE id_gardu LIKE '%$pencarian%'";
                              $query = $sql;
                            $queryJml = $sql;                            
                            } else {
                              $query = "SELECT * FROM tb_pelaksana LIMIT $posisi, $batas";
                              $query = "SELECT * FROM tb_pelaksana";
                              $no = $posisi + 1;
                            }
                          } else {
                            $query = " SELECT * FROM tb_pelaksana LIMIT $posisi, $batas";
                            $querJml = " SELECT * FROM tb_pelaksana";
                            $no = $posisi + 1; 
                          }
                           $sql_gardu = mysqli_query($con, $query) or die ( mysqli_error($con));
                          if(mysqli_num_rows($sql_gardu) > 0){
                            while($data = mysqli_fetch_array($sql_gardu)){
                              ?>
                              <tr>
                              <td><?=$data['id_gardu']?></td>
                              <td><?=$data['tanggal']?></td>
                              ...
                              <td class="text-center">
                                <a href="edit.php?id=<?=$data['id_gardu']?>"><i class ="fas fa-edit"></i></a>
                                <a href="delete.php?id=<?=$data['id_gardu']?>"><i class ="fas fa-trash-alt"></i></a>
                            </td>
                            </tr>
                            <?php
